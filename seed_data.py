test_clozes = {
    ...
    "qué": [
        ...
        ["Dime qué pasó anoche.", "Tell me what happened last night."],
    ],
    "cuando": [
        ["Cuando tenga tiempo, te ayudo.", "When I have time, I’ll help you."],
        ["Avísame cuando estés listo.", "Let me know when you’re ready."],
    ],
    "ella": [
    ...
    "han": [
        ["Mis primos han viajado a Japón.", "My cousins have traveled to Japan."],
        ["¿Cuántas veces han llamado hoy?", "How many times have they called today?"],
    ],
    "desde": [
        ["Desde niño me gusta el fútbol.", "Since I was a child I’ve liked football."],
        ["Desde aquí se ve toda la ciudad.", "From here you can see the whole city."],
    ],
    "sobre": [
        ["Puse los platos sobre la mesa.", "I put the plates on the table."],
        [
            "Leí un artículo sobre cambio climático.",
            "I read an article about climate change.",
        ],
    ],
    "tener": [
        ["Debo tener cuidado con el sol.", "I must be careful with the sun."],
        [
            "Vamos a tener una reunión a las tres.",
            "We’re going to have a meeting at three.",
        ],
    ],
    "así": [
        ["No me gusta así, cámbialo.", "I don’t like it like that, change it."],
        ["Así aprenderás más rápido.", "This way you’ll learn faster."],
    ],
    "cómo": [
        ["Enséñame cómo se hace.", "Show me how it’s done."],
        ["¿Cómo se dice “love” en español?", "How do you say “love” in Spanish?"],
    ],
    "sólo": [
        ["Sólo queda una manzana.", "There’s only one apple left."],
        ["Vine sólo a saludar.", "I came just to say hello."],
    ],
    "hacer": [
        ["¿Qué podemos hacer esta noche?", "What can we do tonight?"],
    ],
    "están": [
    ...
    "sus": [
        ["Sus zapatos son de marca.", "Their shoes are designer."],
        ["Sus abuelos viven en Sevilla.", "Their grandparents live in Seville."],
    ],
    "ver": [
        ["Vamos a ver el partido juntos.", "Let’s watch the game together."],
        ["¿Puedes ver la hora en mi reloj?", "Can you see the time on my watch?"],
    ],
    "sin": [
        [
            "Salí sin paraguas y llovió.",
            "I went out without an umbrella and it rained.",
        ],
        ["Prefiero té sin azúcar.", "I prefer tea without sugar."],
    ],
    "mucho": [
        ["Gracias, me ayudas mucho.", "Thank you, you help me a lot."],
        ["Estudio mucho para el examen.", "I study a lot for the exam."],
    ],
    "entonces": [
        [
            "Llegó tarde, entonces perdió el vuelo.",
            "He/she arrived late, so missed the flight.",
        ],
        ["Entonces, ¿aceptas el trabajo?", "So, do you accept the job?"],
    ],
    "dos": [
        [
            "Necesito dos entradas para el concierto.",
            "I need two tickets for the concert.",
        ],
        ["Dame dos minutos más.", "Give me two more minutes."],
    ],
    "porque": [
        ["Estudio español porque me encanta.", "I study Spanish because I love it."],
        ["No contesté porque estaba dormido.", "I didn’t answer because I was asleep."],
    ],
    "eso": [
        ["Eso me parece una gran idea.", "That seems like a great idea to me."],
        ["No hagas eso otra vez.", "Don’t do that again."],
    ],
    "estoy": [
        ["Estoy en la estación esperando.", "I’m at the station waiting."],
        ["Estoy feliz de verte.", "I’m happy to see you."],
    ],
    "uno": [
        ["El número uno es mi favorito.", "Number one is my favorite."],
        ["Dame uno pequeño, por favor.", "Give me a small one, please."],
    ],
    "vez": [
        ["Es la última vez que te lo digo.", "It’s the last time I tell you."],
        ["Cada vez que llueve me deprimo.", "Every time it rains I get depressed."],
    ],
    "todos": [
        ["Todos debemos ayudar en casa.", "We all have to help at home."],
        ["Todos menos tú llegaron a tiempo.", "Everyone except you arrived on time."],
    ],
    "estás": [
        ["Estás en mi corazón.", "You are in my heart."],
        ["¿Estás seguro de eso?", "Are you sure about that?"],
    ],
    "donde": [
        ["Vamos donde quieras.", "Let’s go wherever you want."],
        [
            "Ése es el restaurante donde cenamos.",
            "That’s the restaurant where we had dinner.",
        ],
    ],
    "he": [
        ["He perdido las llaves otra vez.", "I’ve lost the keys again."],
        ["He decidido cambiar de trabajo.", "I’ve decided to change jobs."],
    ],
    "ir": [
        ["¿Vamos a ir de compras?", "Are we going shopping?"],
        ["Prefiero ir caminando.", "I prefer to walk."],
    ],
    "bien": [
        ["¡Qué bien lo pasamos ayer!", "We had such a good time yesterday!"],
        ["¿Estás bien después del accidente?", "Are you okay after the accident?"],
    ],
    "dijo": [
        ["Nadie dijo nada cuando entré.", "Nobody said anything when I came in."],
        ["El profesor dijo que era fácil.", "The teacher said it was easy."],
    ],
    "nada": [
        ["No queda nada de pastel.", "There’s nothing left of the cake."],
        ["No entiendo nada de matemáticas.", "I don’t understand anything about math."],
    ],
    "está": [
        ["El museo está abierto hasta las ocho.", "The museum is open until eight."],
        ["Mi coche está en el taller.", "My car is at the garage."],
    ],
    "quiero": [
        ["Quiero aprender a cocinar paella.", "I want to learn to cook paella."],
        ["Ahora mismo quiero silencio.", "Right now I want silence."],
    ],
    "antes": [
        ["Termina antes de las cinco.", "Finish before five."],
        ["Antes de dormir leo un capítulo.", "Before sleeping I read a chapter."],
    ],
    "saber": [
    ...
    "hace": [
        ...
        ["Hace sol, ¡vamos a la piscina!", "It’s sunny, let’s go to the pool!"],
    ],
    "ellos": [
        ["Ellos hablan inglés perfectamente.", "They speak English perfectly."],
        ["Ellos mismos arreglaron el coche.", "They fixed the car themselves."],
    ],
    "aquí": [
        ["Siéntate aquí a mi lado.", "Sit here next to me."],
        ["Aquí hace más calor que allí.", "It’s hotter here than there."],
    ],
    "cómo": [
        [
            "Explícame paso a paso cómo funciona.",
            "Explain to me step by step how it works.",
        ],
        [
            "No imagino cómo sobrevivió al accidente.",
            "I can’t imagine how he survived the accident.",
        ],
    ],
}
